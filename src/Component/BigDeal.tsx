...
const BigDeal = () => {
  return (
    <section className="big-deal-container">
      <div className="deal-inner-container">
        <header className="heading-section ">
          <h3 className="head-title big-heading">
            Big <span className="inner-head-title">Deals</span>
          </h3>
        ...
        <div className="deal-category-container">
          <div className="deal-scrollable-container">
            <div className="deal-scroll-content">
              <button className="content-btn-active">All Deals</button>
              <button className="content-btn">True Wireless Earbuds</button>
              <button className="content-btn">Smartwatches</button>
              <button className="content-btn">Speakers And Soundbars</button>
              <button className="content-btn">Neckbands And Headphones</button>
            </div>
          </div>
        </div>
        <CardGrid/>
